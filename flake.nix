{
  ...
  outputs =
    ...
    in
    {
      ...
      # and reach the services via MagicDNS); the headscale server's noise/DERP
      # private keys are provisioned through sops-nix from artificial secrets
      # generated by the test; run with
